      ...
      <section className="flex flex-col md:flex-row md:items-end justify-between gap-6 bg-linear-to-r from-primary-container/10 to-transparent p-6 rounded-2xl border border-outline-variant/30">
        <div>
          ...
          <p className="text-lg text-on-surface-variant mt-1">
            You have <span className="text-primary font-bold">3 classes</span>{" "}
            active today and a project milestone due soon.
          </p>
          <p className="text-xs text-outline mt-1 italic">
            Major: {major} • Semester: Spring 2024
          </p>
        </div>
              ...
              {courses.slice(0, 2).map((course) => (
                ...
                >
                  <div>
                    ...
                    <h4 className="font-bold text-on-surface group-hover:text-primary transition-colors text-base line-clamp-1">
                      {course.title}
                    </h4>
                    <p className="text-xs text-on-surface-variant mt-1 mb-4 line-clamp-2">
                      {course.description}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs font-bold text-on-surface mt-0.5 line-clamp-1">
                          {course.nextLesson}
                        </p>
                      </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs text-outline italic">
                Updated live from student center
              </span>
            </div>
            ...
            <div className="bg-white border border-outline-variant rounded-xl overflow-hidden divide-y divide-outline-variant/50 shadow-xs">
              {activityLog.map((log) => (
                <div
                  key={log.id}
                  className="p-4 flex gap-4 hover:bg-surface-container-low transition-colors group"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start gap-2">
                      ...
                      <span className="text-xs text-outline shrink-0 whitespace-nowrap">
                        {log.time}
                      </span>
                    </div>
              ...
              {deadlines.slice(0, 2).map((dl) => (
                ...
                >
                  <div className="flex flex-col items-center pt-1">
                    ...
                    <div className="w-px flex-1 bg-outline-variant mt-2 min-h-7.5"></div>
                  </div>
                  <div className="flex-1 pb-1">
                    ...
                    <h5 className="text-xs font-bold text-on-surface group-hover:text-primary transition-colors line-clamp-1">
                      {dl.title}
                    </h5>
            ...
            <div className="space-y-3">
              ...
              >
                <p className="text-xs font-bold text-on-surface group-hover:text-secondary transition-colors">
                  Course Survey: Dr. Alan Turing
                </p>
                <p className="text-[10px] text-on-surface-variant italic">
                  Advanced Algorithms • Due in 2 days
                </p>
              </div>
              <div
                onClick={() => onNavigate("settings")}
              ...
              >
                <p className="text-xs font-bold text-on-surface group-hover:text-secondary transition-colors">
                  Review Syllabus: Prof. Sarah Chen
                </p>
                <p className="text-[10px] text-on-surface-variant italic">
                  Neural Networks 101 • Verified
                </p>
              </div>
            </div>
            <button
